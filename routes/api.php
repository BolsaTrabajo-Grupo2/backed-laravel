...
Route::get('student/{email}', [\App\Http\Controllers\Api\StudentApiController::class, 'getStudentByEmail']);
...
Route::get('/company/{email}', [\App\Http\Controllers\Api\CompanyApiController::class, 'getCompanyByEmail']);
